    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="mx-auto max-w-xl space-y-4">
        ...
        <a
          ...
          className="flex items-center gap-4 rounded-xl border border-whisper-border bg-surface p-5 transition-all hover:border-whisper-border hover:shadow-sm"
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-warm-white">
        ...
        >
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-warm-white">
            <Github className="h-6 w-6 text-muted" />
          </div>
          <div>
            <p className="font-medium text-heading">GitHub</p>
            <p className="text-sm text-muted">
        ...
        {cvData.linkedin && (
          ...
          >
            <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-warm-white">
              <Linkedin className="h-6 w-6 text-muted" />
            </div>
            <div>
              <p className="font-medium text-heading">LinkedIn</p>
              <p className="text-sm text-muted">
                Connect on LinkedIn
              </p>
            </div>
