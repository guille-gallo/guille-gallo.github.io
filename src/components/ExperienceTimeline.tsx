...
export function ExperienceTimeline({ experiences }: ExperienceTimelineProps) {
  return (
    <div className="relative space-y-8">
      {/* Timeline line */}
      <div className="absolute left-4 top-0 h-full w-0.5 bg-border sm:left-1/2 sm:-translate-x-0.5" />
      ...
      {experiences.map((exp, index) => (
        ...
        >
          ...
          <div className="rounded-2xl border border-border/60 bg-surface/80 p-5 shadow-[var(--shadow-card)] backdrop-blur-sm">
