    ...
    <div className="relative">
      ...
      <div className="mt-2 flex items-center justify-center gap-3">
        <button
          ...
          className="rounded-full bg-surface/90 p-3 text-foreground shadow-[var(--shadow-card)] ring-1 ring-border/60 backdrop-blur transition hover:bg-surface hover:shadow-[var(--shadow-elevated)]"
