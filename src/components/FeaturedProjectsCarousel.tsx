    ...
    <div className="relative">
      ...
      <div className="mt-2 flex items-center justify-center gap-3">
        <button
          ...
          className="rounded-full bg-surface p-3 text-foreground shadow-[var(--shadow-glass)] ring-1 ring-border backdrop-blur-xl transition hover:shadow-[var(--shadow-elevated)]"
