        ...
        {activeProject && (() => {
          ...
          return (
            <article
              ...
              id={projectId}
              className="relative scroll-mt-28 rounded-2xl border border-border bg-surface p-6"
            >
              ...
              {liveUrl && (
                <div className="absolute right-6 top-6">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 rounded-full bg-surface-2 px-3 py-1 text-xs font-medium text-muted transition-colors hover:bg-accent-soft hover:text-foreground"
                  >
