  ...
  return (
    <div className="mt-10 grid gap-8 md:grid-cols-[220px_minmax(0,1fr)]">
      <aside className="md:sticky md:top-24 md:self-start">
        <div className="rounded-2xl border border-border bg-surface p-4 shadow-[var(--shadow-glass)] backdrop-blur-xl">
        ...
        {activeProject && (() => {
          ...
          return (
            <article
              ...
              id={projectId}
              className="relative scroll-mt-28 rounded-2xl border border-border bg-surface p-6 shadow-[var(--shadow-glass)] backdrop-blur-xl"
            >
