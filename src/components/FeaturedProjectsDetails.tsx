  ...
  return (
    <div className="mt-10 grid gap-8 md:grid-cols-[220px_minmax(0,1fr)]">
      <aside className="md:sticky md:top-24 md:self-start">
        <div className="rounded-2xl border border-border/60 bg-surface/80 p-4 shadow-[var(--shadow-card)] backdrop-blur-sm">
        ...
        {activeProject && (() => {
          ...
          return (
            <article
              ...
              id={projectId}
              className="relative scroll-mt-28 rounded-2xl border border-border/60 bg-surface/80 p-6 shadow-[var(--shadow-card)] backdrop-blur-sm"
            >
              ...
              {liveUrl && (
                <div className="absolute right-6 top-6">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 rounded-full bg-surface-2 px-3 py-1 text-xs font-medium text-muted transition hover:bg-accent-soft hover:text-foreground"
                  >
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 overflow-hidden rounded-xl border border-border/60 bg-surface-2">
                  {demoVideoUrl ? (
                    ...
                    <>
                      {Array.from({ length: 2 }).map((_, index) => (
                        <div
                          ...
                          className="flex h-40 items-center justify-center rounded-lg border border-dashed border-border/60 bg-surface-2 text-xs uppercase tracking-wide text-muted"
                        >
