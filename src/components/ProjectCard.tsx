...
export function ProjectCard({ project, index = 0 }: ProjectCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex h-full flex-col rounded-2xl border border-border/60 bg-surface/80 p-5 shadow-[var(--shadow-card)] backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:shadow-[var(--shadow-elevated)]"
    >
      {/* Header */}
