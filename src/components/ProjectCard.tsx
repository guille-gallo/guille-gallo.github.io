...
export function ProjectCard({ project, index = 0 }: ProjectCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group relative flex h-full flex-col rounded-2xl border border-border bg-surface p-5 transition-all hover:-translate-y-0.5 hover:border-border-strong hover:bg-surface-2"
    >
      {/* Header */}
